...
JAVAPROTEGE=/mnt/c/Users/gonzalem/Desktop/win/win/Protege-5.5.0_win/jre
TGT=$HOME/bin
...
$JAVAPROTEGE/bin/java  -Dfile.encoding=UTF8 -classpath $CLASSPATH org.acoli.conll.rdf.$*
#if
